...
#define _IRR_WAYLAND_DYNAMIC_LOAD_
...
#ifdef NO_IRR_COMPILE_WITH_X11_DEVICE_
...
#if !defined(_IRR_COMPILE_WITH_EGL_MANAGER_) && !defined(__EMSCRIPTEN__)
#define _IRR_COMPILE_WITH_EGL_MANAGER_
#endif
#if defined(_IRR_COMPILE_WITH_WINDOWS_DEVICE_) && !defined(_IRR_COMPILE_WITH_WGL_MANAGER_)
#define _IRR_COMPILE_WITH_WGL_MANAGER_
...
#ifdef NO_IRR_WAYLAND_DYNAMIC_LOAD_
#undef _IRR_WAYLAND_DYNAMIC_LOAD_
#endif
