...
mkdir -p release
"$BUILD_TOOLS_PATH"/apksigner sign --ks keys.jks --ks-pass pass:"$JKS_PASS" --out release/EDOPro-release-patch.apk build/outputs/apk/release/EDOPro-release-unsigned-aligned.apk
